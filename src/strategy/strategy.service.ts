...
import { Equity, Instrument } from 'src/data/data'
...
import { Exchange } from 'src/types/app/entities'
import { clamp } from 'src/utils'

type ExecutionContext = {
  equity: Instrument
  existingCallOption: Position
...
export class StrategyService {
  private readonly tokens: Set<number> = new Set()
  private processingMutex = new Mutex()

  private readonly context: Map<number, ExecutionContext> = new Map()
  ...
  // private updateCurrentToken = (token: number) => {
  //   this.currentToken = token
  // }

  // private updateStrategyContext = async () => {
  //   const equityInfo = DataService.getInstument(this.currentToken)

  //   console.log(`getting info for ${this.currentToken}`)
